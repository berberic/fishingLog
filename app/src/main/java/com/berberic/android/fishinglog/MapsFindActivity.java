...
/**
 * Created by berberic on 2/11/2018.
 */

public class MapsFindActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public static Intent newIntent(Context packageContext, String Lat_Lng) {
        Intent intent = new Intent(packageContext, MapsFindActivity.class);
