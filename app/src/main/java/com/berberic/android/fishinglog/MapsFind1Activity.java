...
/**
 * Created by berberic on 2/13/2018.
 */
...
public class MapsFind1Activity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public static Intent newIntent(Context packageContext, UUID fishlogId){
        Intent intent = new Intent(packageContext, MapsFind1Activity.class);
  ...
  //      mCurrLocationMarker = mMap.addMarker(markerOptions);
    ...
    private void saveNewMark(){
        ...
        mFishlog = FishlogLab.get(this).getFishlog(mUUID);
        String AccLoc = mFishlog.getLocDesc();



        //   if (AccLoc.contains("LAT:"))
        //       AccLoc = AccLoc.substring(0,AccLoc.indexOf("LAT:")-1);

        mFishlog.setLocDesc(LocDescName + " "+LATLNG);
